...
object DummyData {
    val TASKS = listOf(
        ...
        NewTask(2, "Project Plan", Instant.parse("2025-04-17T18:29:04Z"), 2, Color.Blue, null),
        NewTask(3, "Homework 99", Instant.parse("2025-04-17T18:29:04Z"), 3, Color.White, null),
        NewTask(4, "Homework 99.5", Instant.parse("2025-04-17T18:29:04Z"), 3, Color.Cyan, null),
