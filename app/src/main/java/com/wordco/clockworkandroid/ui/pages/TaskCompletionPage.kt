    ...
    Box(
        ...
        Column (
            ...
            Button(
                ...
                Text(
                    text = "View Details",
                    style = TextStyle(fontSize = 24.sp), color = MaterialTheme.colorScheme.onPrimaryContainer
                )
            }
            ...
            Button(
                ...
                Text(
                    text = "Continue",
                    style = TextStyle(fontSize = 40.sp), color = MaterialTheme.colorScheme.onPrimaryContainer
                )
            }
